...
public class UserListActivity extends AppCompatActivity {
    ...
    private DatabaseReference usersDatabaseReerence;
    ...
    private void attachUserDatabaseReferenceListener() {
        usersDatabaseReerence = FirebaseDatabase.getInstance().getReference().child("users");
        if (usersChildEventListener == null){
            ...
            usersDatabaseReerence.addChildEventListener(usersChildEventListener);
        }
    }
